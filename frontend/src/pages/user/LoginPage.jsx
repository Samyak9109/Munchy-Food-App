...
export default function UserLoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setAuth(res.data.account, res.data.accessToken, "user");
      navigate("/");
    } catch (err) {
        ...
        <div className="w-full max-w-sm space-y-stack-lg">
          <div className="text-center space-y-stack-sm">
            ...
            <p className="text-body-md text-on-surface-variant">
              Code sent to <span className="text-primary">{form.email}</span>
            </p>
          </div>
          ...
          <form onSubmit={handleVerify} className="space-y-stack-lg">
            ...
            <button
              ...
              className="w-full bg-secondary-container text-on-secondary font-montserrat font-bold text-title-md py-4 rounded-xl neon-glow-yellow disabled:opacity-50 active:scale-[0.98] transition-all"
            >
  ...
  return (
    <div className="min-h-dvh bg-background flex flex-col items-center justify-center px-margin-mobile relative overflow-hidden">
      {/* ambient glow */}
      ...
      <div className="w-full max-w-sm space-y-stack-lg relative z-10">
        {/* Logo */}
        <div className="text-center space-y-stack-sm">
          ...
          <p className="text-body-md text-on-surface-variant">
            Discover food. Pick it up. Enjoy.
          </p>
        </div>
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary-container text-on-primary-container font-montserrat font-bold text-title-md py-4 rounded-xl neon-glow-red disabled:opacity-50 active:scale-[0.98] transition-all mt-stack-sm"
          >
            {loading
              ? "Please wait..."
              : step === "login"
        ...
        <p className="text-center text-body-md text-on-surface-variant">
          ...
          <button
            ...
            className="text-secondary-container font-bold hover:opacity-80 transition-opacity"
          >
            Partner Hub →
          </button>
        </p>
